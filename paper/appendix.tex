...
\end{align}
These estimates are much smaller than that due to the
...
on the growth of the one-armed spiral in the inner disc. 
...
%Interpreting the one-armed spiral as an external po-
%tential for the outer disc, 
...
negative angular momentum \citep{lin11b}. This
effect is small in our simulations, but it could be significant
