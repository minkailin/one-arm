...
\begin{abstract} 
  ...
  is associated with the imposed 
...
neccessary for accretion \citep{lynden-bell72, papaloizou91,balbus99,lodato04}, and
...
accretion. Dead zones may then become
...
This work presents a first step towards this goal. Specifically, we 
...
one-arm perturbation and requires a massive disc \citep[the former may
...
three-dimensions (3D). We also apply results from linear
