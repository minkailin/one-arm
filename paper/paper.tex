...
\begin{abstract} 
  ...
  gradient. This enables angular momentum exchange between the spiral
  and the background disc, and may lead to instability if the  
  interaction increases the amplitude of the linear perturbations. 
