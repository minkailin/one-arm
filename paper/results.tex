...
relative to the local rotation. Thus, the spiral 
...
Fig. \ref{fargo_wavenumber} the normalised radial wavenumber associated with
the $m=1$ spiral. We find 
\begin{align*}
...
means the spiral is trailing, as seen in Fig. \ref{2d_fargo_viz}.  
