...
{\bf We show that the growth of the $m=1$ spiral is
  ...
  series of simulations with $q\in[0,1]$,  However, to keep the Toomre $Q$
...
% \S\ref{global_cons}. 
% According to Eq. \ref{baroclinic_torque}, this
...
% we invoke angular momentum conservation for linear
% perturbations, Eq. \ref{lin_ang_mom_cons}. 
% Assuming fluxes are
...
momentum, {\bf leading to its growth.} 
This is consistent with angular momentum component
