...
\end{align*}
Both are smaller than the 2D simulations, because of to the
low resolutions adopted in 3D and/or the small softening length employed in
2D. 
%Fig. \ref{3d_ampmax} also show results from strictly isothermal
...
as well as with the 2D simulations, is satisfactory. The largest
spiral amplitude is found in $R\in[R_1,R_2]$ independent of
height. However, notice the spiral pattern extends into the
non-self-gravitating outer disc ($R>R_2$) at $z\sim 2H$, i.e. 
