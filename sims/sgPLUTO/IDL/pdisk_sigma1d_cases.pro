pro pdisk_sigma1d_cases, cases=cases, start=start, xrange=xrange, yrange=yrange, xtickinterval=xtickinterval, ytickinterval=ytickinterval, $
  ...
  filename = strcompress('pdisk_sigma1d_'+name2+'.dat',/remove_all)
  ...
  set_plot, 'ps'
  device, filename=strcompress('pdisk_sigma1d_cases_'+name2+'.ps',/remove_all) $
