; $Id: //depot/Release/ENVI50_IDL82/idl/idldir/lib/polar_contour.pro#1 $
;
; Copyright (c) 1995-2012, Exelis Visual Information Solutions, Inc. All
;       rights reserved. Unauthorized reproduction is prohibited.

PRO Polar_Contour1, z, theta, r, SHOW_TRIANGULATION=show, DITHER=dither, $
         IRREGULAR=irregular, tol=tol, $
         _Extra = e
;
;+
; NAME:
...
if keyword_set(dither) then begin
    ...
    triangulate, x+randomu(seed, n_elements(x))*scale, $
      y + randomu(seed, n_elements(y))*scale, tr, TOLERANCE=tol
endif else begin
    triangulate, x, y, tr, TOLERANCE=tol
endelse
