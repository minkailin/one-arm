; $Id: //depot/Release/ENVI50_IDL82/idl/idldir/lib/polar_surface.pro#1 $
;
; Copyright (c) 1992-2012, Exelis Visual Information Solutions, Inc. All
;       rights reserved. Unauthorized reproduction is prohibited.

function polar_surface1, z, r, theta, GRID = grid, SPACING = sp, $
	BOUNDS = bounds, QUINTIC = quintic, MISSING = missing, tol=tol
;+
; NAME:
;	POLAR_SURFACE
;
