...
typedef struct DATA{
  ...
  double ****Ylm;   /**<3D array to store spherical harmonics. first index is re/im part. only used for potential recons.*/
  ...
  double ***phi_weights_m; /**3D array to store weights for phi integration. first index is re/im part*/
  double ***Philm;/**<3D array to store the local Phi_lm(r). first index is re/im part */
  double ***Phi; /**<3D array to store self-potential */
  double **beta2d; /*array to store density mod due to sg*/
