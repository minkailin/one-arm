...
pro compare_profiles, cases=cases, start=start, finish=finish, zslice=zslice $
             ...
             ,legend=legend, label=label,ksq=ksq
...
endcase
    ...
    if keyword_set(ksq) then data1d = deriv(rad,rad^2*data1d^2)
