; THIS PROCEDURE CALCULATES OMEGA (VERT. CPT. OF VORTICITY) ON THE GRID POINTS USING
; CENTRAL DIFFERENCING. THIS VERSION PLOTS OMEGA AS WE GO AROUND
; A CIRCLE OF RADIUS RAD. DEFAULT IS TO NOT SET RAD, AND USE PLANET
; RADIUS. ALSO SET PLANET AZIMUTH=0, CENTER OF PLOT.
pro omgazi, loc=loc, start=start, finish=finish, rad=rad
common consts, pi
...
;;;Note: since here we only caculate omega and don't need sigma, we
;;;could have caculated omega at lower left corner of each grid
;;;point. In this case we don't need to average. 
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
set_plot, 'ps'
device, filename=filepath(strcompress('omgazi'+ks+'.ps',/remove_all),root_dir='.',subdir=[location])$
