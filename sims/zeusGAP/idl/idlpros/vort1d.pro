...
pro vort1d, loc=loc, start=start, finish=finish, plazi=plazi, opp=opp
common consts, pi
common array, data1d
pi=3.141592654
...
plot,rmed(1:nrad-2),data1d(0:nrad-3)$
,title=time+' orbits',xmargin=[8,6],ymargin=[3,3],xtitle=xxtitle,ytitle=yytitle $
,charsize=1.5,xrange=[min(rmed),max(rmed)],xtickinterval=0.4,xminor=4,yrange=plotrange
;oplot, rmed(1:nrad-2), eqline, linestyle=2
;;;;;;;;;;;;;;;;;;;;
;MARK PLANET RADIUS;
;;;;;;;;;;;;;;;;;;;;
