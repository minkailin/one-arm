; $Id: velovect.pro,v 1.15.4.1 1999/01/16 16:46:23 scottm Exp $
;
...
PRO VELOVECT2,U,V,X,Y, Missing = Missing, Length = length, Dots = dots,  $
        Color=color, CLIP=clip, NOCLIP=noclip, OVERPLOT=overplot, _EXTRA=extra, hsize=hsize
;
;+ 
; NAME:
;	VELOVECT
...
;
        ...
        st = r * sin(angle)*hsize             ;sin 22.5 degs * length of head
        ct = r * cos(angle)*hsize
;
